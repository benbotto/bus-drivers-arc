...
The Crash Analysis toolbox has 3 major tools: Crash Radius Density, Crash Network Density, and Network K Analysis. Each one of these tools acts takes an existing crash data and takes in various inputs (defined by each tool) and outputs analysis by each type of tool. 
